  ...
  return new Promise((resolve, reject) => {
    ...
    getProfile(provider, query, async (err, profile) => {
      ...
      try {
        ...
        //Create basic user
        const createdBasicUser = await strapi.services['basic-user'].create({
        ...
        const params = _.assign(profile, {
          ...
          role: defaultRole.id,
          confirmed: true,
          basic_user: createdBasicUser.id
        });
  ...
  switch (provider) {
        ...
        .request((err, res, body) => {
          ...
          if (err) {
            ...
            callback(null, {
              ...
              email: body.email,
              name: body.name,
              pic: body.picture && body.picture.data && body.picture.data.url
            });
          }
        });
      break;
    ...
    case 'google': {
      ...
      google
        ...
        .qs({ access_token })
        .request((err, res, body) => {
          // console.log(body,body.name, "Body")
          if (err) {
            callback(err);
          } else {
            callback(null, {
